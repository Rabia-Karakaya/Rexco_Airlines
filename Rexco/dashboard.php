...
.sidenav a{display:block; text-decoration:none; font-size:20px; color:#aaa; padding: 8px 8px 8px 20px; transition:0.3s; }
...
<div class="sidenav" id="sidebarNav">
  ...
  <a href="seferler2.php">Seferler</a>
...
<main id="main">
<h2 style="text-align: center; color: #003666; font-size: 24px; padding: 20px; border-bottom: 2px solid #003666;">Rexco Airlines Raporları</h2>
